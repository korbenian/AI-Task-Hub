  ...
  return (
    <div className='min-h-screen flex items-center justify-center px-4 py-12'>
      <form
        ...
        className='backdrop-blur-xl bg-white/20 border border-white/30 p-8 rounded-3xl shadow-2xl w-full  bg-gradient-to-br from-blue-500 via-purple-500 to-pin-500 max-w-md space-y-6 text-white'
      >
        ...
        <div>
          ...
          <div className='flex items-center border border-gray-300 rounded-xl px-4 py-2 focus-within:ring-2 focus-within:ring-blue-500 transition relative'>
            <svg
